...
public class Sprweb20jpaJoinApplication {
	...
	public void initMembers() {
		...
		try {
			List<String> queries = new ArrayList<String>(); //List<String>에 sql문을 담아둠
		...
		//40번 부서의 다른 정보를 이용해 직원정보를 저장할 것이 아니면 find 없이 부서번호만 Dept객체에 넣는다
		//롬복의 builder()를 사용하여 Dept객체를 빌더 패턴으로 생성
